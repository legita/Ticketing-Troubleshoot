...
<div id="about" class="section wb" style="color: black;">
    ...
    $stemming=$keluhanuji;
     ...
     <br>
      ...
      <?php
     //======================================       
     $sql="select * from tbl_keluhan  order by `id_keluhan` desc limit 200";      //      limit 0,10          
        ...
        $gab2.="Cosine Similarity Terhadap tiap-tiap dokumen:<br>";
          ...
          $HarKat[$i-1]=$arKat[$i];
           ...
           $sql="Update tbl_datauji set normalisasi='$stemming', perangkat='$kategori', tanggal='$tanggal', 
                 penanganan='$penanganan', flag='1'  where id_datauji='$id_datauji'";
